...
class Employee(AbstractBaseUser, PermissionsMixin):
    ...
    national_id_number = models.CharField(max_length=64, blank=True, null=True)
    ...
    employee_id = models.CharField(
        ...
        null=True,
        db_index=True,
        help_text="Auto-generated on activation e.g. FPP-WH-2026-0042-K",
    )
    ...
    rfid_tag = models.CharField(
        ...
        null=True,
        blank=True,
        help_text="MIFARE RFID card UID — encoded when physical card is printed",
    )
    card_status = models.CharField(
        ...
        help_text="Physical ID card status",
    )
    ...
    authority_roles = models.ManyToManyField(
        "Human_Resources.AuthorityRole",
        blank=True,
        related_name="employees",
    )
